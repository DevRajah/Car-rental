                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;"> Dear ${name},<br/>Below is your One Time Password (OTP) to reset your password.</h3>
                                <p><a href="" class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 3px; background: #ed7f06; color: #ffffff; text-decoration: none; font-size: 30px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 500;">${otp}</a></p>
