...
<head>
    ...
    <style>
        ...
        div {
            width: 70%; 
            height: max-content; 
            background: rgba(224, 255, 255, 0.297); 
            border-radius: 5px; 
...
<body>
    <div>
        <h1>Privacy Policy of 5 Square</h1>

    <p>5 Square operates the <a href="https://fivesquares.onrender.com/">https://fivesquares.onrender.com/</a> website, which provides the E-COMMERCE SERVICE.</p>

    <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of
        Personal Information if anyone decided to use our Service, the 5 Square website.</p>
    ...
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
        at <a href="https://fivesquares.onrender.com/">https://fivesquares.onrender.com/</a>, unless otherwise defined in this Privacy Policy.</p>
    ...
    <p>Email: big5ive2024@gmail.com or visit our platform contact us page <a href="https://fivesquares.onrender.com/">https://fivesquares.onrender.com/</a></p>
    </div>
</body>
