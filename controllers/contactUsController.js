...
const config = require('../dbConfig/config.json')

const contactUs = async (req, res) => {
  const { yourName, emailAddress, subject, message, businessDepartment } = req.body;
